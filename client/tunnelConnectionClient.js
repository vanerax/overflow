...
function TunnelConnectionClient(socket) {
   this._socket = socket;
   this._proxyMap = {};
   this._bindRequestMap = {};
}
util.inherits(TunnelConnectionClient, TunnelConnection);

TunnelConnectionClient.getInstance = function() {
   if (!_instance) {
...
module.exports = TunnelConnectionClient;
